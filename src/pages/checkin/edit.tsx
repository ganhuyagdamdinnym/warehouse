...
const CheckinEdit = () => {
  ...
  const baseInputClass = "mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm transition-all focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 outline-none";
        ...
        <div className="px-4 md:px-0 border-b border-gray-100 pb-6">
          <h3 className="text-lg font-bold text-gray-900">
            <div className="flex items-center gap-2">
              <a href="#" className="text-blue-600 hover:underline">Орлого</a>
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="px-4 py-6 bg-white border border-gray-200 md:p-8 md:rounded-t-md space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative mt-1">
                      ...
                      <input type="text" placeholder="Дугаар оруулна уу" className={`${baseInputClass} pl-10`} />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="relative" ref={containerRef}>
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-gray-300 rounded-lg py-2.5 pl-11 pr-10 text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 outline-none transition-all shadow-sm"
                      />
                      <HiChevronDown className={`absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 transition-transform ${isOpen ? "rotate-180" : ""}`} />
                    </div>
                      ...
                      <div className="absolute z-50 w-full mt-2 bg-white border border-gray-200 rounded-lg shadow-xl max-h-64 overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-200">
                        {filteredItems.length > 0 ? (
                          filteredItems.map((item, index) => (
                            ...
                            >
                              <span>{item}</span>
                              <span className="text-[10px] bg-gray-100 px-1.5 py-0.5 rounded uppercase font-bold text-gray-400">Сонгох</span>
                            </div>
                          ))
                        ) : (
                          <div className="px-4 py-6 text-center text-gray-400 text-sm">Илэрц олдсонгүй</div>
                        )}
                      </div>
                    )}
                  </div>
                      ...
                      <tbody>
                        <tr>
                          <td colSpan={5} className="px-6 py-12 text-center text-gray-400 italic">
                            Жагсаалт хоосон байна. Дээрх хайлтаар бараа нэмнэ үү.
                          </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="mt-2 group cursor-pointer border-2 border-dashed border-gray-200 rounded-xl p-8 transition-all hover:bg-blue-50/30 hover:border-blue-300 flex flex-col items-center justify-center text-center">
                    <HiOutlineCloudUpload className="w-10 h-10 text-gray-300 group-hover:text-blue-500 transition-colors" />
                    <p className="mt-2 text-sm text-gray-600 font-medium italic">Файл чирч оруулна уу</p>
                    <p className="text-xs text-gray-400 mt-1">.png, .jpg, .pdf, .docx, .xlsx</p>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-yellow-50/50 rounded-lg w-fit pr-6 border border-yellow-100">
                ...
                />
                <label htmlFor="draft" className="text-sm text-yellow-800 font-bold cursor-pointer">
            ...
            <div className="flex items-center justify-between px-4 py-5 bg-gray-50 border-x border-b border-gray-200 md:px-8 md:rounded-b-md">
              ...
              <div className="flex items-center gap-4">
                <button type="button" className="text-gray-500 hover:text-gray-700 font-bold text-sm">Цуцлах</button>
                <button
                  type="submit"
