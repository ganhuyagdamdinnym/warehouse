              ...
              <div className="p-6 md:p-8 space-y-8">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div
                        ...
                        className="mt-1.5 border-2 border-dashed border-gray-200 bg-gray-50/50 rounded-xl p-6 flex flex-col items-center justify-center cursor-pointer hover:bg-blue-50/50 hover:border-blue-300 transition-all group"
                      >
                        {imagePreview ? (
                          <img
                            src={imagePreview}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    {allocations.length === 0 ? (
                      <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center text-xs text-gray-400 bg-gray-50/20">
